...
<div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
	...
	<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
		<a href="index.html" class="d-lg-none">
			<img alt="Logo" src="${pageContext.request.contextPath}/resources/design/media/logos/default.svg" class="h-25px" />
		</a>
	</div>
	<!--end::Mobile logo-->
	...
	<div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
		...
		<div class="app-navbar align-items-center flex-shrink-0">
			...
			<div class="app-navbar-item ms-2 ms-lg-4">
				...
				<div id="kt_header_search" class="header-search d-flex align-items-center w-lg-250px" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="enter" data-kt-search-layout="menu" data-kt-search-responsive="lg" data-kt-menu-trigger="auto" data-kt-menu-permanent="true" data-kt-menu-placement="bottom-end" data-kt-menu-attach="parent">
					...
					<!-- <form data-kt-search-element="form" class="d-none d-lg-block w-100 position-relative mb-5 mb-lg-0" autocomplete="off">
						...
						begin::Icon
						<i class="ki-duotone ki-magnifier fs-2 fs-lg-3 text-gray-800 position-absolute top-50 translate-middle-y ms-5">
							<span class="path1"></span>
							<span class="path2"></span>
						</i>
						end::Icon
								...
								<div class="scroll-y mh-200px mh-lg-350px">
									...
									<a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
										...
										<div class="symbol symbol-40px me-4">
											<img src="${pageContext.request.contextPath}/resources/design/media/avatars/300-6.jpg" alt="" />
										</div>
										<!--end::Symbol-->
										<!--begin::Title-->
									...
									<a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
										<!--begin::Symbol-->
										<div class="symbol symbol-40px me-4">
											<img src="${pageContext.request.contextPath}/resources/design/media/avatars/300-2.jpg" alt="" />
										</div>
										<!--end::Symbol-->
										<!--begin::Title-->
										<div class="d-flex flex-column justify-content-start fw-semibold">
									...
									<a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
										<!--begin::Symbol-->
										<div class="symbol symbol-40px me-4">
											<img src="${pageContext.request.contextPath}/resources/design/media/avatars/300-9.jpg" alt="" />
										</div>
										<!--end::Symbol-->
										<!--begin::Title-->
										<div class="d-flex flex-column justify-content-start fw-semibold">
									...
									<a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
										<!--begin::Symbol-->
										<div class="symbol symbol-40px me-4">
											<img src="${pageContext.request.contextPath}/resources/design/media/avatars/300-14.jpg" alt="" />
										</div>
										<!--end::Symbol-->
										<!--begin::Title-->
										<div class="d-flex flex-column justify-content-start fw-semibold">
									...
									<a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
										<!--begin::Symbol-->
										<div class="symbol symbol-40px me-4">
											<img src="${pageContext.request.contextPath}/resources/design/media/avatars/300-11.jpg" alt="" />
										</div>
										<!--end::Symbol-->
										<!--begin::Title-->
										<div class="d-flex flex-column justify-content-start fw-semibold">
									...
									<a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
										...
										<div class="symbol symbol-40px me-4">
											<span class="symbol-label bg-light">
												<img class="w-20px h-20px" src="${pageContext.request.contextPath}/resources/design/media/svg/brand-logos/volicity-9.svg" alt="" />
											</span>
										</div>
										<!--end::Symbol-->
										<!--begin::Title-->
									...
									<a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
										...
										<div class="symbol symbol-40px me-4">
											<span class="symbol-label bg-light">
												<img class="w-20px h-20px" src="${pageContext.request.contextPath}/resources/design/media/svg/brand-logos/tvit.svg" alt="" />
											</span>
										</div>
										<!--end::Symbol-->
										<!--begin::Title-->
									...
									<a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
										...
										<div class="symbol symbol-40px me-4">
											<span class="symbol-label bg-light">
												<img class="w-20px h-20px" src="${pageContext.request.contextPath}/resources/design/media/svg/misc/infography.svg" alt="" />
											</span>
										</div>
										<!--end::Symbol-->
										<!--begin::Title-->
									...
									<a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
										...
										<div class="symbol symbol-40px me-4">
											<span class="symbol-label bg-light">
												<img class="w-20px h-20px" src="${pageContext.request.contextPath}/resources/design/media/svg/brand-logos/leaf.svg" alt="" />
											</span>
										</div>
										<!--end::Symbol-->
										<!--begin::Title-->
									...
									<a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
										...
										<div class="symbol symbol-40px me-4">
											<span class="symbol-label bg-light">
												<img class="w-20px h-20px" src="${pageContext.request.contextPath}/resources/design/media/svg/brand-logos/tower.svg" alt="" />
											</span>
										</div>
										<!--end::Symbol-->
										<!--begin::Title-->
			...
			<!--end::Search-->
				...
				<div class="app-navbar-item ms-2 ms-lg-4">
						<a href="#"
						class="btn btn-icon btn-primary fw-bold" id="alarmBtn"
						data-kt-menu-trigger="click" data-kt-menu-attach="parent"
						style="position: relative;"> <!-- 아이콘 --> <span class="fs-5">
							<span class="material-symbols-outlined">notifications</span>
					</span> <!-- 					<span class="symbol-badge badge badge-circle bg-danger" -->
							...
							<div id="wheel-x"
								...
								<ul class="itemss"
									...
									<li class="itemsss"
										...
										data-bs-toggle="tab" href="#kt_topbar_notifications_1">Q&A</a>
									</li>
								</ul>
							</div>
							<!--end::Tabs-->
...
<%-- 				class="me-auto">${alarmVO.alarmCategory }</strong> <small>${alarmVO.alarmCrtDt }</small> --%>
<!-- 			<button type="button" class="btn-close" data-bs-dismiss="toast" -->
<!-- 				aria-label="Close"></button> -->
<!-- 		</div> -->
<%-- 		<div class="toast-body">${alarmVO.alarmCn }</div> --%>
<!-- 	</div> -->
<!-- </div> -->
<!--end::Toast-->
</div>
		 ...
		 $.ajax({
             ...
             success: function(alarmList){
				 ...
				 for(let i=0; i<alarmList.length; i++){
				  ...
				  if(alarm.alarmCategory == "QnA"){
					 spanClass = "symbol-label bg-light-warning";
					 iconClass ="bi bi-chat-right-dots";
				  }


				  alarmHTML +=	`
				    <div class="d-flex py-4" style="padding-top:15 !important; padding-bottom:0 !important;">
...
// 					<i class="ki-duotone ki-abstract-23 fs-2 text-success me-3"><span
// 						class="path1"></span><span class="path2"></span></i> <strong
// 						class="me-auto">alarmCategory</strong> <small>\${alarmVO.alarmCrtDt }</small>
// 					<button type="button" class="btn-close" data-bs-dismiss="toast"
// 						aria-label="Close"></button>
// 				</div>
// 				<div class="toast-body">alarmCn</div>
// 			</div>
// 		</div>
// 		`;
