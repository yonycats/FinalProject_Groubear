...
<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="250px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
	...
	<div class="app-sidebar-toolbar d-flex flex-stack py-6 px-8">
		<div class="nav bg-light rounded-pill px-3  w-225px">
			<c:choose>
				<c:when test="${empty workStatusVO }">
					<!--  근무 시작 -->
					<button id="startWorkBtn" class="btn btn-outline btn-outline-dashed btn-outline-secondary btn-active-light-secondary" style="width: 100%; display: inline-flex; align-items: center; justify-content: center; text-align: center;">
				...
				<c:otherwise>
					<!--  근무 종료 -->
					<button id="stopWorkBtn" class="btn btn-outline btn-outline-dashed btn-outline-secondary btn-active-light-secondary" style="width: 100%; display: inline-flex; align-items: center; justify-content: center; text-align: center;">
...
<!-- 			</div> -->
			...
			<div data-kt-menu-trigger="click" class="menu-item menu-accordion hiddenMenu" id="menu_001">
				<span class="menu-link">
					<span class="menu-icon">
				...
				<div class="menu-sub menu-sub-accordion">
					<div class="menu-item">
						<a class="menu-link" href="/empinformation/allinfo.do">
							<span class="menu-bullet">
								<span class="bullet bullet-dot"></span>
							</span>
							<span class="menu-title">전체 사원 관리</span>
						</a>
					</div>
				</div>
			</div>

            <div data-kt-menu-trigger="click" class="menu-item menu-accordion hiddenMenu" id="menu_002">
				<span class="menu-link">
					<span class="menu-icon">
				...
				<div class="menu-sub menu-sub-accordion menu-active-bg">
					<div class="menu-item">
						<a class="menu-link" href="/employee/commute/management.do">
							<span class="menu-bullet">
								<span class="bullet bullet-dot"></span>
							</span>
							<span class="menu-title">출퇴근 관리</span>
						</a>
					</div>
					<div class="menu-item">
						<a class="menu-link" href="/employee/vacation/history.do">
							<span class="menu-bullet">
								<span class="bullet bullet-dot"></span>
							</span>
							<span class="menu-title">휴가 생성 내역</span>
						</a>
					</div>
					<div class="menu-item">
						<a class="menu-link" href="/employee/vacation/applicationhistory.do">
							<span class="menu-bullet">
								<span class="bullet bullet-dot"></span>
							</span>
							<span class="menu-title">휴가 신청 내역</span>
						</a>
					</div>
					<div class="menu-item">
						<a class="menu-link" href="/employee/vacation/approval.do">
							<span class="menu-bullet">
								<span class="bullet bullet-dot"></span>
							</span>
							<span class="menu-title">휴가 승인</span>
						</a>
					</div>
				</div>
			</div>
			...
			<div data-kt-menu-trigger="click" class="menu-item menu-accordion hiddenMenu" id="menu_005">
                <span class="menu-link">
                   <span class="menu-icon">
                   ...
                   <span class="menu-title">증명서</span>
                   <span class="menu-arrow"></span>
                </span>
                <div class="menu-sub menu-sub-accordion">
                   <div class="menu-item">
                      <a class="menu-link" href="/employee/provedocAplyList.do">
                         <span class="menu-bullet">
                            <span class="bullet bullet-dot"></span>
                         </span>
			...
			<div data-kt-menu-trigger="click" class="menu-item menu-accordion hiddenMenu" id="menu_008">
				...
				<div class="menu-sub menu-sub-accordion">
					<div class="menu-item">
						<a class="menu-link" href="/employee/organizationchart.do">
							<span class="menu-bullet">
								<span class="bullet bullet-dot"></span>
							</span>
							<span class="menu-title">조직도</span>
			...
			<div data-kt-menu-trigger="click" class="menu-item menu-accordion hiddenMenu" id="menu_003">
			    <span class="menu-link">
			        <span class="menu-icon">
			    ...
			    <div class="menu-sub menu-sub-accordion">
			        <div class="menu-item">
			            <a class="menu-link" href="/employee/elaprMain.do">
			                <span class="menu-bullet">
			                    <span class="bullet bullet-dot"></span>
			                </span>
			                <span class="menu-title">전자결재</span>
			        ...
			        <div class="menu-item">
			            <a class="menu-link" href="/employee/elaprForm.do">
			                <span class="menu-bullet">
			                    <span class="bullet bullet-dot"></span>
			                </span>
			                <span class="menu-title">새 결재 진행하기</span>
			            </a>
			        </div>
			        <div class="menu-item">
						<a class="menu-link" href="/employee/empElaprAll.do">
						      <span class="menu-bullet">
						            <span class="bullet bullet-dot"></span>
						      </span>
						      <span class="menu-title">전체 문서함</span>
						</a>
					</div>
			        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
			            <span class="menu-link">
			            ...
			            <div class="menu-sub menu-sub-accordion">
			                ...
			                <div class="menu-item">
			                    <a class="menu-link" href="/employee/empMyElaprAll.do">
			                        <span class="menu-bullet">
			                            <span class="bullet bullet-dot"></span>
			                        </span>
			                        <span class="menu-title">개인 전체 문서함</span>
			                    </a>
			                </div>
			            </div>
			        </div>
			...
			<div data-kt-menu-trigger="click" class="menu-item menu-accordion hiddenMenu" id="menu_006">
			   <span class="menu-link">
			      <span class="menu-icon">
			   ...
			   <div class="menu-sub menu-sub-accordion">
			      <div class="menu-item">
			         <a class="menu-link" href="/employee/project.do">
			            <span class="menu-bullet">
			               <span class="bullet bullet-dot"></span>
			            </span>
			            <span class="menu-title">프로젝트</span>
			...
			<div data-kt-menu-trigger="click" class="menu-item menu-accordion hiddenMenu" id="menu_007">
				<span class="menu-link">
					<span class="menu-icon">
				...
				<div class="menu-sub menu-sub-accordion">
					<div class="menu-item">
						<a class="menu-link" href="/employee/calendar.do">
							<span class="menu-bullet">
								<span class="bullet bullet-dot"></span>
							</span>
			...
			<div data-kt-menu-trigger="click" class="menu-item menu-accordion hiddenMenu" id="menu_013">
				<span class="menu-link">
					<span class="menu-icon">
				...
				<div class="menu-sub menu-sub-accordion">
					<div class="menu-item">
						<a class="menu-link" href="/employee/cloudList.do ">
							<span class="menu-bullet">
								<span class="bullet bullet-dot"></span>
							</span>
							<span class="menu-title">클라우드</span>
			...
			<div data-kt-menu-trigger="click" class="menu-item menu-accordion hiddenMenu" id="menu_012">
				<span class="menu-link">
					<span class="menu-icon">
				...
				<div class="menu-sub menu-sub-accordion">
					<div class="menu-item">
						<a class="menu-link" href="/employee/communityCompany.do">
							<span class="menu-bullet">
								<span class="bullet bullet-dot"></span>
							</span>
							<span class="menu-title">커뮤니티</span>
			...
			<div data-kt-menu-trigger="click" class="menu-item menu-accordion hiddenMenu" id="menu_014">
				<span class="menu-link">
					<span class="menu-icon">
					...
					<span class="menu-title">차량 예약</span>
					<span class="menu-arrow"></span>
				</span>
				<div class="menu-sub menu-sub-accordion">
					<div class="menu-item">
						<a class="menu-link" href="/empvehicle/vehicledashboard.do">
							<span class="menu-bullet">
								<span class="bullet bullet-dot"></span>
							</span>
							<span class="menu-title">차량 예약</span>
			...
			<div data-kt-menu-trigger="click" class="menu-item menu-accordion hiddenMenu" id="menu_015">
				<span class="menu-link">
					<span class="menu-icon">
						<i class="bi bi-shop">
							<span class="path1"></span>
					...
					<span class="menu-title">시설예약</span>
					<span class="menu-arrow"></span>
				</span>
				<div class="menu-sub menu-sub-accordion">
					<div class="menu-item">
						<a class="menu-link" href="/employee/facilities/status.do">
							<span class="menu-bullet">
								<span class="bullet bullet-dot"></span>
							</span>
					...
					<div class="menu-item">
						<a class="menu-link" href="/employee/facilities/reserve/status.do">
							<span class="menu-bullet">
								<span class="bullet bullet-dot"></span>
							</span>
			...
			<div data-kt-menu-trigger="click" class="menu-item menu-accordion hiddenMenu" id="menu_011">
				<span class="menu-link">
					<span class="menu-icon">
					...
					<span class="menu-title">화상채팅</span>
					<span class="menu-arrow"></span>
				</span>
				<div class="menu-sub menu-sub-accordion">
					<div class="menu-item">
						<a class="menu-link" href="/employee/videochatting.do">
							<span class="menu-bullet">
								<span class="bullet bullet-dot"></span>
							</span>
							<span class="menu-title">화상 채팅</span>
						</a>
					</div>
				</div>
			</div>
...
<!-- 			</div> -->
			...
			<div data-kt-menu-trigger="click" class="menu-item menu-accordion hiddenMenu" id="menu_016">
				<span class="menu-link">
					<span class="menu-icon">
				...
				<div class="menu-sub menu-sub-accordion">
					...
					<div class="menu-item">
						<a class="menu-link" href="/employee/menuRecommend.do">
							<span class="menu-bullet">
								<span class="bullet bullet-dot"></span>
							</span>
			...
			<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
				...
				<div class="menu-sub menu-sub-accordion">
					<div class="menu-item">
						<a class="menu-link" href="/employee/cmntyNoticeList.do">
							<span class="menu-bullet">
								<span class="bullet bullet-dot"></span>
							</span>
					...
					<div class="menu-item">
						<a class="menu-link" href="/employee/cmntyQstnList.do">
							<span class="menu-bullet">
								<span class="bullet bullet-dot"></span>
							</span>
