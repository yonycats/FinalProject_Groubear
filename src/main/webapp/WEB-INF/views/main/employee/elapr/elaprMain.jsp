								...
								<div class="card card-flush h-lg-100">
									...
									<div class="card-footer">
										...
										<!-- <div class="text-gray-700 fw-semibold fs-6 me-2"> -->
											<a href="/employee/elaprDetail.do?elaprNo=${elaprVO.elaprNo }" class="btn btn-primary">결재하기</a>
										<!-- </div> -->
										<!--end::Section-->
									</div>
									<!--end::Item-->
				...
				<div class="card mb-5 mb-xl-10">
					...
					<div class="card-header">
						...
						<div class="card-toolbar">
							<c:choose>
								<c:when test="${status eq 'APRZ002' }">
									<a href="/employee/empMyElaprComplete.do" class="btn btn-sm btn-light-success my-1">더보기</a>
								</c:when>
								<c:when test="${status eq 'APRZ003' }">
									<a href="/employee/empMyElaprRjct.do" class="btn btn-sm btn-light-success my-1">더보기</a>
								</c:when>
							</c:choose>
						</div>
						<!--end::Toolbar-->
											...
											<c:forEach items="${elaprTableList }" var="elaprVO">
												<c:if test="${elaprVO.elaprSttsCd eq status }">
													<tr>
														...
														<td>
															<a href="/employee/elaprDetail.do?elaprNo=${elaprVO.elaprNo }" class="text-hover-primary text-gray-600">
																${elaprVO.elaprNm }
															</a>
														</td>
