				...
				<div class="card mb-5 mb-xl-10">
					...
					<div class="card-header">
						...
						<div class="card-toolbar">
							<c:choose>
								<c:when test="${status eq 'APRZ002' }">
									<a href="/employee/empElaprComplete.do" class="btn btn-sm btn-light-success my-1">더보기</a>
								</c:when>
								<c:when test="${status eq 'APRZ003' }">
									<a href="/employee/empElaprRjct.do" class="btn btn-sm btn-light-success my-1">더보기</a>
								</c:when>
							</c:choose>
						</div>
						<!--end::Toolbar-->
