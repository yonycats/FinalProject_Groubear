								...
								<div class="card card-flush mb-5 mt-5" style="min-height: 18em; display: flex; justify-content: center; margin-bottom: 1em;">
	                                    ...
	                                    <div class="mt-4 ms-5" style="display: flex; min-height: 6em; padding-top: 1em;">  
	                                       ...
	                                       <div style="width: 70%;">  
											...
											<!-- 발표를 위한 데이터 세팅 -->
											<input type="text" class="form-control" id="newFldrName" name="cloudStrgFldrNm" value="결재관련폴더">
	            ...
	            <div class="card card-flush" style="height : 100%;">
	                ...
	                <div class="card-header">
	                    ...
	                    <div class="card-toolbar"> 
	                        ...
	                        <div class="d-flex justify-content-end" data-kt-filemanager-table-toolbar="base">
	                            <button type="button" class="btn btn-flex btn-light-primary me-1 px-4" data-bs-toggle="modal" data-bs-target="#kt_modal_newFolder" onclick="f_cloudNewFlrdJobgradeCall()">
...
function f_cloudNewFlrdJobgradeCall() {
