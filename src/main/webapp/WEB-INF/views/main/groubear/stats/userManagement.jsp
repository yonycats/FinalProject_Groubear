...
<div class="d-flex flex-wrap flex-center justify-content-lg-between mx-auto w-xl-900px">
    <!--begin::Item-->
    <div class="d-flex flex-column flex-center h-150px w-150px h-lg-200px w-lg-200px m-3 bg-primary-light rounded-circle" style="background-color: #B3C8CF;">
        <!--begin::Symbol-->
        <span class="fs-4x text-white mb-3">
           	  <div class="overlay-wrapper text-gray-600">
                                <i class="ki-duotone ki-briefcase fs-5x"><span class="path1"></span><span class="path2"></span></i>
                                </div>
        </span>
        <!--end::Symbol-->
    ...
    <!--begin::Item-->
    <div class="d-flex flex-column flex-center h-150px w-150px h-lg-200px w-lg-200px m-3 bg-primary-light rounded-circle" style="background-color: #BED7DC;">
        <!--begin::Symbol-->
        <span class="fs-4x text-primary mb-3">
           <div class="overlay-wrapper text-gray-600">
                   <i class="ki-duotone ki-profile-user fs-5x"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span></i>
                </div>
        </span>
        <!--end::Symbol-->
    ...
    <!--begin::Item-->
    <div class="d-flex flex-column flex-center h-150px w-150px h-lg-200px w-lg-200px m-3 bg-primary-light rounded-circle" style="background-color: #F1EEDC;">
        <!--begin::Symbol-->
        <span class="fs-4x text-primary mb-3">
           <div class="overlay-wrapper text-gray-600">
                                <i class="ki-duotone ki-questionnaire-tablet fs-5x"><span class="path1"></span><span class="path2"></span></i></div>
        </span>
        <!--end::Symbol-->
    ...
    <!--begin::Item-->
    <div class="d-flex flex-column flex-center h-150px w-150px h-lg-200px w-lg-200px m-3 bg-primary-light rounded-circle" style="background-color: #E5DDC5;">
        <!--begin::Symbol-->
        <span class="fs-4x text-primary mb-3">
            <div class="overlay-wrapper text-gray-600">
                                <i class="ki-duotone ki-text-align-justify-center fs-5x"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span></i>
                                </div>
        </span>
        <!--end::Symbol-->
        ...
        <div class="mb-0">
            <!--begin::Value-->
            <div class="fs-lg-2hx fs-2x fw-bold text-white d-flex flex-center">
                <div class="min-w-70px" data-kt-countup="true" data-kt-countup-value="1000" data-kt-countup-suffix="+">0</div>
            </div>
            <!--end::Value-->
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="card card-bordered">
            <div class="card-body">
                <table class="table align-middle table-row-dashed fs-6 gy-5 table-bordered" id="kt_ecommerce_products_table_1">
                    <thead>
                            ...
                            <c:forEach var="yearItem" items="${yearlyData}">
                                <tr>
                                    ...
                                    <td><div class="text-center">
                                    	<fmt:formatNumber value= "${yearItem.totalPayment}" pattern="#,###" />원
                                    	</div>
                                    </td>
<!--                                     <td><div class="text-center">부가세 예정</div></td> -->
<!--                                     <td><div class="text-center">합계 예정</div></td> -->
    ...
    <div class="col-md-6">
        <div class="card card-bordered">
            <div class="card-body">
                <table class="table align-middle table-row-dashed fs-6 gy-5 table-bordered" id="kt_ecommerce_products_table_2">
                    <thead>
                        <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0 text-center">
