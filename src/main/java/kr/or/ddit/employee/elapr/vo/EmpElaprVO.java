package kr.or.ddit.employee.elapr.vo;
...
public class EmpElaprVO {
	...
	private List<EmpAplnVO> aplnList;		// 결재선
	private List<EmpRerncVO> rerncList;		// 참조
	private List<EmpElaprPrslVO> prslList;	// 열람
