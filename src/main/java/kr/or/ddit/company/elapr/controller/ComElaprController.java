...
public class ComElaprController {
	...
	@Inject
	private IComElaprService comEelaprService;
	...
	public String elaprList(
		...
		int totalRecord = comEelaprService.comSelectElaprCount(pagingVO);
		
		pagingVO.setTotalRecord(totalRecord);
		
		List<EmpElaprVO> formList = comEelaprService.comSelectElaprList(pagingVO);
