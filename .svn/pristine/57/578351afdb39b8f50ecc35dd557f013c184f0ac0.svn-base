...
<form action="/employee/empElaprInsert.do" id="formInsert" method="post">
	<c:if test="${status eq 'u' }">
											...
											<div class="card-header">
		                                         <div class="card-title" style="width: 100%;">
		                                            <div style="width: 100%; display: flex; justify-content: space-between;">
		                                              ...
		                                              <%--  <form action="/employee/empElaprDelete.do" method="post" id="delForm">
		                                               		<input type="hidden" name="elaprNo" value="${elaprVO.elaprNo }"/>
		                                               </form> --%>
		                                               		...
		                                               		<div class="modal-dialog modal-dialog-scrollable">
		                                               			<div class="modal-content">
																	...
																	<div class="modal-body" style="min-height: 200px">
																		...
																		<div class="mb-10 fv-row">
																			...
																			<label class="form-check form-check-custom form-check-solid me-10">
																				<input class="form-check-input h-15px w-15px" type="checkbox" id="elaprEmrgYn" name="elaprEmrgYn" value="Y" >
																	...
																	<div class="modal-footer">
																		...
																		<!-- <button type="button" id="addBtn" class="btn btn-primary me-2">결재요청</button> -->
...
$(function () {
	...
	addBtn.on('click', function () {
	    ...
	    // 긴급문서 체크 여부 확인
	    let elaprOpnnCn = $("#elaprOpnnCn").val();
	    let elaprEmrgYn = $('#elaprEmrgYn').is(":checked") ? 'Y' : 'N';
	    ...
	    // 필수 항목 검증
	    if ( elaprNm == null || elaprNm == "" || 
	    	elaprOpnnCn == null || elaprOpnnCn == "") {
	        Swal.fire({
	            icon: 'warning',
	            title: '필수 입력이 비어있습니다.',
	    ...
	    // 수정일 때
	    if ($(this).val() == '결재재요청') {
	        formInsert.attr("action", "/employee/empElaprUpdate.do");
	    }
	...
	delBtn.on('click', function () {
		Swal.fire({
			...
			if (result.isConfirmed) {
				formInsert.attr("action", "/employee/empElaprDelete.do");
				formInsert.submit();
			}
		})
	});
	...
	$("#previewBtn").on("click", function () {
		...
		$.ajax({
			...
			success : function (data) {
				...
				$.ajax({
					url : "/employee/empElaprSelectImpl.do",
					type : "get",
					dataType : "JSON",
					success : function (data) {
						console.log(data);
