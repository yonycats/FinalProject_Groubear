...
public class EmpMyElaprController {
	...
	public String elaprDraft(
		...
		List<EmpElaprVO> dataList = myElaprService.selectMyElaprDraftList(pagingVO);
	...
	public String empElaprRernc (
		...
		List<EmpElaprVO> dataList = myElaprService.selectRerncList(pagingVO);
	...
	public String empElaprPrsl (
		...
		List<EmpElaprVO> dataList = myElaprService.selectPrslList(pagingVO);
	...
	public String empElaprAll(
		...
		List<EmpElaprVO> dataList = myElaprService.selectAllList(pagingVO);
	...
	public String empElaprEmrg(
		...
		List<EmpElaprVO> dataList = myElaprService.selectEmrgList(pagingVO);
	...
	public String empElaprProgress(
		...
		List<EmpElaprVO> dataList = myElaprService.selectProgressList(pagingVO);
	...
	public String empElaprComplete(
		...
		List<EmpElaprVO> dataList = myElaprService.selectCompleteList(pagingVO);
	...
	public String empElaprRjct(
		...
		List<EmpElaprVO> dataList = myElaprService.selectRjctList(pagingVO);
	...
	public String empMyElaprAll(
		...
		List<EmpElaprVO> dataList = myElaprService.selectMyAllList(pagingVO);
	...
	public String empMyElaprEmrg(
		...
		List<EmpElaprVO> dataList = myElaprService.selectMyEmrgList(pagingVO);
	...
	public String empMyElaprProgress(
		...
		List<EmpElaprVO> dataList = myElaprService.selectMyProgressList(pagingVO);
	...
	public String empMyElaprComplete(
		...
		List<EmpElaprVO> dataList = myElaprService.selectMyCompleteList(pagingVO);
	...
	public String empMyElaprRjct(
		...
		List<EmpElaprVO> dataList = myElaprService.selectMyRjctList(pagingVO);
