...
<div class="row col-12 px-5">
				        ...
				        <div class="container mt-3">
				            ...
				            <div class="scrollable-list" style="max-height: 510px; overflow-y: auto;">
				                <table class="table table-borderless" id="addrEmpList">
				                    <tbody>
				                        <c:forEach items="${orgEmpList}" var="emp">
				                            <tr>
	...
	<div class="col-12 col-xl-5">
		<div class="card card-flush h-xl-100 d-flex flex-column" id="empIdChk">
			...
			<div class="separator separator-dashed my-0"></div>
			<div class="row card-body pt-5">
			   <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 pt-5 pb-5" style="height: 650px; background-color: #ddf8fc" id="empDetail">
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-center flex-column py-5">
                            ...
                            <div class="d-flex flex-wrap flex-center">
                                <div class="mb-5">
                                    <div class="badge badge-lg badge-light-primary d-inline">\${emp.jbgdCd}</div>
                                </div>
                                <div class="mb-5 mx-2">
                                    <div class="badge badge-lg badge-light-primary d-inline">\${emp.empJncmpYmd}</div>
                                </div>
                            </div>
                            <div class="d-flex flex-wrap flex-center">
                                <div class="border border-gray-300 border-dashed rounded py-3 px-3 mb-3" style="background-color: #81DAE3">
                                    <div class="fs-4 fw-bold text-white">
                                        <span class="bullet bg-white mb-1"></span>
                                        <span class="w-75px">\${emp.deptCd}</span>
                                    </div>
                                    <div class="fw-semibold text-white">\${emp.teamCd}</div>
                                </div>
                                <div class="border border-gray-300 border-dashed rounded py-3 px-3 mx-4 mb-3" style="background-color: #81DAE3">
                                    <div class="fs-4 fw-bold text-white">
                                        <span class="w-50px">메일</span>
                                        <i class="ki-duotone ki-sms fs-5" style="color:white;">
                                            <span class="path1"></span>
                                            <span class="path2"></span>
                                        </i>
                                    </div>
                                    <div class="fw-semibold text-white">\${emp.empEmlAddr}</div>
                                </div>
                            </div>
                        </div>
                    </div>
