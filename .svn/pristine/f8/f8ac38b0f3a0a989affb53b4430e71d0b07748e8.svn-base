...
<!-- 						<td>X</td> -->
		...
		<div class="d-flex justify-content-end pb-10">
			<div class="align-items-center">
				<a href="#" class="btn btn-danger btn-active-text-gray-900" id="empDeleteDiv">
				...
				<a href="#" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#kt_modal_modify_user">
				수정</a>
