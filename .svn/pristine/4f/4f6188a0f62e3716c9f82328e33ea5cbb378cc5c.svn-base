		...
		<div class="menu menu-column menu-sub-indention menu-active-bg fw-semibold" id="#kt_sidebar_menu" data-kt-menu="true">
			...
			<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
				...
				<div class="menu-sub menu-sub-accordion">
					...
					<div class="menu-item">
						<!--begin:Menu link-->
						<a class="menu-link" href="/groubear/cmntyNoticeList.do">
							<span class="menu-bullet">
								<span class="bullet bullet-dot"></span>
							</span>
					...
					<div class="menu-item">
						<!--begin:Menu link--> 
						<a class="menu-link" href="/groubear/cmntyQstnList.do">
							<span class="menu-bullet">
								<span class="bullet bullet-dot"></span>
							</span>
			...
			<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
				...
				<div class="menu-sub menu-sub-accordion">
					...
					<div class="menu-item">
						<!--begin:Menu link-->
						<a class="menu-link" href="/groubear/formList.do">
							<span class="menu-bullet">
								<span class="bullet bullet-dot"></span>
							</span>
							<span class="menu-title">양식 관리</span>
...
<!-- 					</div> -->
					...
					<div class="menu-item">
						<!--begin:Menu link-->
						<a class="menu-link" href="/groubear/usermanagementYear.do">
							<span class="menu-bullet">
								<span class="bullet bullet-dot"></span>
							</span>
					...
					<div class="menu-item">
						<!--begin:Menu link-->
						<a class="menu-link" href="/groubear/companydetailnumofmem.do">
							<span class="menu-bullet">
								<span class="bullet bullet-dot"></span>
							</span>
