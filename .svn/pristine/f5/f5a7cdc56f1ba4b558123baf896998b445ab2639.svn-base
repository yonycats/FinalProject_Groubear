							...
							<div class="card card-flush" style="margin-bottom: 40px;">
									...
									<div class="card-header align-items-center py-5 gap-2 gap-md-5">
										...
										<div class="card-title">
											<!--begin::Select-->
											<!-- <select class="form-select form-select-solid" id="selectVal" data-control="select2" data-dropdown-css-class="w-200px" data-placeholder="Select an option" data-hide-search="true">
											    <option selected >출근 상태</option>
											    <option value="출근">정상 출근</option>
											    <option value="WS002">지각</option>
											    <option value="WS003">결근</option>
											    <option value="WS004">병가</option>
													...
													<c:otherwise>
														<c:forEach items="${List }" var="item">
															<tr>
																...
																<td>
																	<button type="button" id="sttsUdtBtn" name="sttsUdtBtn" class="btn btn-light-danger" value="${item.empId }">
														                	수정
														            </button>
																</td>
															</tr>
