                                     ...
                                     <div class="card-body pt-0" style="margin-top: 20px;">
                                         <div class="mb-10 fv-row fv-plugins-icon-container">
                                            ...
                                            <div style="display: flex;">
                                               <div style="width: 13%;">
                                                   <label class="form-label" style="margin-top: 10px;">양식명 <font style="color: red">*</font></label>
                                               </div> 
                                               	   <c:choose>
	                                               		<c:when test="${status ne 'i' }">
			                                               <sec:authentication property="principal.member" var="emp"/>
			                                               <c:choose>
			                                               		<c:when test="${emp.empId eq formVO.empId}">
					                                                <input style="width: 85%;" type="text" id="docFormNm" name="docFormNm" class="form-control mb-2" placeholder="양식명을 입력해주세요." value="${formVO.docFormNm }"> 
			                                               		</c:when>
			                                               		<c:otherwise>
					                                                <input style="width: 85%;" type="text" id="docFormNm" name="docFormNm" class="form-control mb-2" placeholder="양식명을 입력해주세요." value="${formVO.docFormNm }" disabled> 
			                                               		</c:otherwise>
			                                               </c:choose>
	                                               		</c:when>
	                                               		<c:otherwise>
                                            ...
                                            <div style="display: flex;">
                                               <div style="width: 13%;">
                                                   <label class="form-label" style="margin-top: 10px;">양식설명 </label>
                                               </div> 
                                               	   <c:choose>
	                                               		<c:when test="${status ne 'i' }">
			                                               <sec:authentication property="principal.member" var="emp"/>
			                                               <c:choose>
			                                               		<c:when test="${emp.empId eq formVO.empId}">
					                                                <input style="width: 85%;" type="text" name="docFormExpln" class="form-control mb-2" placeholder="양식 설명을 입력해주세요." value="${formVO.docFormExpln }"> 
			                                               		</c:when>
			                                               		<c:otherwise>
					                                                <input style="width: 85%;" type="text" name="docFormExpln" class="form-control mb-2" placeholder="양식 설명을 입력해주세요." value="${formVO.docFormExpln }" disabled> 
			                                               		</c:otherwise>
			                                               </c:choose>
	                                               		</c:when>
	                                               		<c:otherwise>
                                            ...
                                            <div style="display: flex; margin-top: 5px;">  
                                               <div style="width: 13%;">
                                                   <label class="form-label" style="margin-top: 10px;">양식종류 <font style="color: red">*</font></label>
                                               </div>  
                                               <div style="width: 20%;"> 
                                               	   <c:choose>  
	                                               		<c:when test="${status ne 'i' }">
			                                               ...
			                                               <c:choose>
				                                                  ...
				                                                  <select id="docFormKndNm" name="docFormKndUp" class="form-select" data-control="select2" data-hide-search="true">
			                                               		...
			                                               		<c:otherwise> 
				                                                  <select id="docFormKndNm" name="docFormKndUp" class="form-select" data-control="select2" data-hide-search="true" disabled="disabled">
				                                                     <option value="0">선택</option>
				                                                     <c:forEach items="${docFormKndNmList }" var="docFormNm"> 
				                                                        <option value="${docFormNm.docFormNo }" <c:if test="${formVO.docFormKndNm == docFormNm.docFormNm }">selected="selected"</c:if>>${docFormNm.docFormNm }</option>
				                                                     </c:forEach>
                                            ...
                                            <div>
                                                <label class="form-label" style="margin-top: 10px;">양식 내용 <font style="color: red">*</font></label>
                                          	</div>
