							...
							<div class="card-body">
								<div class="d-flex flex-column fv-row">
									...
									<label class="fs-5 fw-semibold">차량 정보 입력</label>
									    ...
									    <div class="col-12">
									        <div class="d-flex">
									            <input type="text" class="form-control form-control-solid mx-1" id="vhclNo" name="vhclNo" placeholder="차량 번호 (ex : 123가1234)">
									            <input type="text" class="form-control form-control-solid mx-1" id="vhclMdlNm" name="vhclMdlNm" placeholder="모델명 (ex : K5)">
									        </div>
									    </div>
									<label class="fs-5 fw-semibold pt-5">차종</label>
									<span class="selection">
									...
									<label class="fs-5 fw-semibold pt-5">연비</label>
									<div class="input-group">
									    <input type="text" class="form-control" placeholder="연비를 입력해주세요(ex : 9.0)" name="vhclAvgFuel">
									    <span class="input-group-text">㎞/ℓ</span>
									</div>
								</div>
							</div>
