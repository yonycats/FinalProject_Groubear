	...
	<div class="d-flex flex-column flex-column-fluid">
		...
		<div id="kt_app_content" class="app-content flex-column-fluid">
			...
			<div id="kt_app_content_container" class="app-container container-fluid">
					...
					<div class="card bg-body me-9 pb-lg-18 col-12 col-xl-8">
						<div class="card-body pb-lg-20">
							...
							<div class="mb-13">
								...
								<div class="modal fade" tabindex="-1" id="reqElapr">
								    <div class="modal-dialog modal-dialog-scrollable">
								        <div class="modal-content">
								            ...
								            <div class="modal-body" style="min-height: 200px">
								                <!-- Form 시작 -->
								                <form id="approvalForm" action="/company/empElaprWatingUpdate.do" method="post">
								                    <!-- 결재문서명 -->
								...
								<div class="modal fade" tabindex="-1" id="rjctElapr">
                              		<div class="modal-dialog modal-dialog-scrollable">
                              			<div class="modal-content">
											...
											<div class="modal-body" style="min-height: 200px">
												<form id="rjctForm" action="/company/empElaprRjctUpdate.do" method="post">
													<div class="mb-10 fv-row">
														<label class="required form-label">결재문서명</label>
														<input type="hidden" name="elaprNo" value="${elaprVO.elaprNo }">${elaprVO.elaprNm }
													</div>
								...
								<form action="/company/empElaprUpdate.do" method="post">
				...
				<form action="/company/empElaprUpdate.do" method="get" id="updateForm">
					<input type="hidden" name="elaprNo" value="${elaprVO.elaprNo }">
				</form>
				<!--end::About main-->
				</div>
...
$(function () {
    ...
    function getStatusImageHTML(statusCode, index) {
        let imagePath = "";
        let leftPosition = 430 + (index * 170); // 첫 번째는 430px, 두 번째는 600px으로 증가
