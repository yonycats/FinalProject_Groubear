							...
							<form class="form" action="/employee/calInsert.do" method="post" id="kt_modal_add_event_form">
								...
								<div class="modal-body py-10 px-lg-17">
									...
									<div class="fv-row mb-9">
										...
										<!--end::Label-->
										<!--begin::Input-->
										<input type="text" class="form-control form-control-solid" placeholder="일정명을 입력해주세요." name="calendarNm" id="calendarNm" value="${calendarVO.calenderNm }"/>
										<!--end::Input-->
									</div>
									<!--end::Input group-->
									<!--begin::Input group-->
									<div class="fv-row mb-9">
										...
										<!--end::Label-->
										<!--begin::Input-->
										<input type="text" class="form-control form-control-solid" placeholder="일정 설명을 입력해주세요." name="calendarCn" id="calendarCn" value="${calendarVO.calenderCn }"/>
										<!--end::Input-->
									</div>
									<!--end::Input group-->
									<!--begin::Input group-->
									...
									<div class="row row-cols-lg-2 g-10">
										...
										<div class="col" data-kt-calendar="datepicker">
											<div class="fv-row mb-9">
												...
												<!--end::Label-->
												<!--begin::Input-->
												<input class="form-control form-control-solid" name="calendar_event_start_time" placeholder="일정 시작 시간을 입력해주세요." id="kt_calendar_datepicker_start_time" />
												<!--end::Input-->
											</div>
										</div>
									</div>
									...
									<div class="row row-cols-lg-2 g-10">
										...
										<div class="col" data-kt-calendar="datepicker">
											<div class="fv-row mb-9">
												...
												<!--end::Label-->
												<!--begin::Input-->
												<input class="form-control form-control-solid" name="calendar_event_end_time" placeholder="일정 종료 시간을 입력해주세요." id="kt_calendar_datepicker_end_time" />
												<!--end::Input-->
											</div>
										</div>
									</div>
...
$(function () {
	let addBtn = $("#kt_modal_add_event_submit");		// 일정 추가 버튼
	
	addBtn.on("click", function () {
		  var calendarNm = $("#calendarNm").val();
		
		  if (calendarNm == null || calendarNm == ""
		  ) {
// 		  if (calendarNm == null || calendarNm == "" ||
// 			  calendarDt == null || calendarDt == "" ||
// 			  calendarEndDt == null || calendarEndDt == "" 
// 		  ) {
		    Swal.fire({
		      icon: 'warning',
		      title: '필수 입력이 비어있습니다.',
