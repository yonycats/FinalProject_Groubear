...
<div id="kt_app_sidebar" class="app-sidebar flex-column"
	...
	<div class="app-sidebar-menu hover-scroll-y my-5 my-lg-5 mx-3"
		...
		<div
			...
			<div data-kt-menu-trigger="click"
				class="menu-item menu-accordion hiddenMenu" id="menu_013">
				<span class="menu-link"> <span class="menu-icon"> <i
				...
				<div class="menu-sub menu-sub-accordion">
					<div class="menu-item">
						<a class="menu-link" href="/employee/cloudList.do "> <span
							class="menu-bullet"> <span class="bullet bullet-dot"></span>
			...
			<div data-kt-menu-trigger="click"
				class="menu-item menu-accordion hiddenMenu" id="menu_016">
				<span class="menu-link"> <span class="menu-icon"> <i
				...
				<div class="menu-sub menu-sub-accordion">
					...
					<!-- 					</div> -->
					<div class="menu-item">
						<a class="menu-link" href="/employee/menuRecommend.do"> <span
							class="menu-bullet"> <span class="bullet bullet-dot"></span>
			...
			<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
				...
				<div class="menu-sub menu-sub-accordion">
					<div class="menu-item">
						<a class="menu-link" href="/employee/cmntyNoticeList.do"> <span
							class="menu-bullet"> <span class="bullet bullet-dot"></span>
						</span> <span class="menu-title">공지사항</span>
						</a>
					</div>
					<div class="menu-item">
						<a class="menu-link" href="/employee/cmntyQstnList.do"> <span
							class="menu-bullet"> <span class="bullet bullet-dot"></span>
