	...
	<body id="kt_app_body" data-bs-spy="scroll" data-bs-target="#kt_landing_menu" data-bs-offset="200" data-kt-app-layout="light-sidebar" class="body-bg position-relative app-blank">
		...
		<div class="d-flex flex-column flex-root" id="kt_app_root">
					...
					<div class="container-xxl position-relative z-index-2">
						...
						<div class="row gy-5 align-items-center gx-0">
							...
							<div class="col-sm-6">
								...
								<div class="pe-5">
									<!--begin::Title-->
									<h1 class="text-gray-900 fw-bold fs-3x fs-lg-4tx mb-14 ms-n1" id="home">Let Your Brand 
									<br />Boost On-board 
									...
									<div class="d-flex flex-shrink-0 me-5">
										<!--begin::Link-->
										<a href="index.html" class="btn btn-primary flex-shrink-0 fw-bold me-2 me-md-4 my-1">Create a Team</a>
										<!--end::Link-->
										<!--begin::Link-->
										<a href="pages/user-profile/projects.html" class="btn btn-white btn-color-gray-700 flex-shrink-0 my-1 fw-bold btn-active-light-primary">Take a Tour</a>
										<!--end::Link-->
									</div>
									<!--end::Action-->
								</div>
			...
			<div class="mb-9 pt-15 z-index-2">
				...
				<div class="container">
					<!--begin::Title-->
					<h3 class="fs-lg-2tx fs-2x text-gray-900 text-center mb-16 lh-base" id="how-it-works" data-kt-scroll-offset="{default: 100, lg: 150}">Our 3-Step Guide for How to Setup 
					...
					<div class="row gy-10 mb-md-20">
						...
						<div class="col-sm-4">
							...
							<div class="text-center mb-10 mb-md-0">
								...
								<div class="d-flex flex-center mb-5">
									...
									<!--end::Badge-->
									<!--begin::Title-->
									<div class="fs-5 fs-lg-3 fw-bold text-gray-900">Create Your Team</div>
									<!--end::Title-->
								</div>
								<!--end::Heading-->
								<!--begin::Description-->
								<div class="fw-semibold fs-6 fs-lg-4 text-gray-700">Hire best developers by using
						...
						<div class="col-sm-4">
							...
							<div class="text-center mb-10 mb-md-0">
								...
								<!--end::Heading-->
								<!--begin::Description-->
								<div class="fw-semibold fs-6 fs-lg-4 text-gray-700">With a few clicks install required
						...
						<div class="col-sm-4">
							...
							<div class="text-center mb-10 mb-md-0">
								...
								<!--end::Heading-->
								<!--begin::Description-->
								<div class="fw-semibold fs-6 fs-lg-4 text-gray-700">We take care of your app deployment
			...
			<div class="mb-0">
				...
				<div class="container-xxl">
					<!--begin::Title-->
					<h3 class="fs-lg-2tx fs-2x text-gray-900 text-center mb-7 mb-lg-16 lh-base position-relative z-index-2" id="fatures" data-kt-scroll-offset="{default: 100, lg: 150}">Timely Connection to Latest Updates
							...
							<div class="pt-6">
								...
								<div class="d-flex align-items-top position-relative z-index-2 mb-7 mb-lg-16">
									...
									<div class="d-flex flex-column">
										<a href="pages/blog/post.html" class="text-gray-900 text-hover-primary fs-3 fw-bold mb-3">This is by far the cleanest template and the most 
										<br />well structured platform</a>
										<span class="text-gray-700 fw-semibold fs-4">The most well thought out design theme I have ever used. 
								...
								<div class="d-flex align-items-top position-relative z-index-2 mb-7 mb-lg-16">
									...
									<div class="symbol symbol-50px me-5 me-lg-9 pt-1">
										<span class="symbol-label bg-light">
											<i class="ki-duotone ki-abstract-25 fs-2x text-danger">
												<span class="path1"></span>
												<span class="path2"></span>
											</i>
										</span>
									...
									<!--begin::Text-->
									<div class="d-flex flex-column">
										<a href="pages/blog/post.html" class="text-gray-900 text-hover-primary fs-3 fw-bold mb-3">How to Write a Blog Post, Step: Writing a Great 
								...
								<div class="d-flex align-items-top position-relative z-index-2">
									...
									<div class="symbol symbol-50px me-5 me-lg-9 pt-1">
										<span class="symbol-label bg-light">
											<i class="ki-duotone ki-abstract-35 fs-2x text-primary">
												<span class="path1"></span>
												<span class="path2"></span>
											</i>
										</span>
									...
									<!--begin::Text-->
									<div class="d-flex flex-column">
										<a href="pages/blog/post.html" class="text-gray-900 text-hover-primary fs-3 fw-bold mb-3">Keep All Your Sentences Short Shorte. Accept That 
				...
				<div class="py-10 pt-md-20 mb-lg-5">
					...
					<div class="container">
						...
						<div class="d-flex flex-column position-relative z-index-2">
							<!--begin::Title-->
							<h1 class="fs-lg-2tx fs-2x fw-bold text-gray-900 mb-7 mb-lg-15 text-center lh-base">Good Rated a Very Strong 5 Star by Users 
							...
							<div class="d-flex flex-column flex-md-row">
								...
								<div class="pe-7">
									...
									<!--begin::Text-->
									<div class="mb-7">
										<h3 class="text-gray-900 fw-bold mb-3 lh-base">This is by far the cleanest template 
										<br />and the most well structured</h3>
										<span class="text-gray-700 d-block fw-semibold fs-4">The most well thought out design theme I have ever used. The codes are up to tandard. The css styles are very clean. In fact the cleanest and the most up to standard I have ever seen.</span>
									</div>
									<!--end::Text-->
									<!--begin::Item-->
									<div class="d-flex align-items-center">
										...
										<div class="flex-grow-1">
											<a href="pages/user-profile/overview.html" class="text-gray-900 fw-bold text-hover-primary fs-6">Paul Miles</a>
											<span class="text-gray-500 d-block fw-semibold">Development Lead</span>
										</div>
										<!--end::User-->
									</div>
									<!--end::Item-->
								...
								<div class="pe-7">
									...
									<div class="d-flex align-items-center">
										...
										<!--begin::User-->
										<div class="flex-grow-1">
											<a href="pages/user-profile/overview.html" class="text-gray-900 fw-bold text-hover-primary fs-6">Janya Clebert</a>
											<span class="text-gray-500 d-block fw-semibold">Project Manager</span>
										</div>
										<!--end::User-->
									</div>
									<!--end::Item-->
								...
								<div class="">
									...
									<div class="d-flex align-items-center">
										...
										<!--begin::User-->
										<div class="flex-grow-1">
											<a href="pages/user-profile/overview.html" class="text-gray-900 fw-bold text-hover-primary fs-6">Steave Brown</a>
											<span class="text-gray-500 d-block fw-semibold">HTML, JS, ReactJS</span>
										</div>
										<!--end::User-->
									</div>
									<!--end::Item-->
				...
				<div class="pt-lg-20 mb-15">
					...
					<div class="container px-0">
						...
						<div class="d-flex flex-column container pt-lg-20">
							<!--begin::Heading-->
							<h1 class="fs-lg-2tx fs-2x fw-bold text-gray-900 mb-7 mb-lg-13 text-center" id="pricing" data-kt-scroll-offset="{default: 100, lg: 150}">One Stop Pricing For Your Business 
							<br />Because 
											...
											<div class="w-100 d-flex flex-column flex-center rounded-3 bg-gray-100 py-15 px-10">
												...
												<div class="w-100 mb-10">
													...
													<div class="d-flex flex-stack mb-5">
														<span class="fw-semibold fs-6 text-gray-600 text-start pe-3">Up to 10 Active Users</span>
													...
													<!--begin::Item-->
													<div class="d-flex flex-stack mb-5">
														<span class="fw-semibold fs-6 text-gray-600 text-start pe-3">Up to 30 Project Integrations</span>
														<i class="ki-duotone ki-check-circle fs-2 text-primary">
															<span class="path1"></span>
															<span class="path2"></span>
														</i>
													...
													<!--begin::Item-->
													<div class="d-flex flex-stack mb-5">
														<span class="fw-semibold fs-6 text-gray-600">Keen Analytics Platform</span>
														<i class="ki-duotone ki-cross-circle fs-2 text-gray-500">
															<span class="path1"></span>
															<span class="path2"></span>
														</i>
													</div>
													...
													<!--begin::Item-->
													<div class="d-flex flex-stack mb-5">
														<span class="fw-semibold fs-6 text-gray-600">Targets Timelines & Files</span>
														<i class="ki-duotone ki-cross-circle fs-2 text-gray-500">
															<span class="path1"></span>
															<span class="path2"></span>
														</i>
													...
													<div class="d-flex flex-stack">
														<span class="fw-semibold fs-6 text-gray-600">Unlimited Projects</span>
														<i class="ki-duotone ki-cross-circle fs-2 text-gray-500">
															<span class="path1"></span>
															<span class="path2"></span>
														</i>
										...
										<div class="d-flex h-100 align-items-center">
											...
											<div class="w-100 d-flex flex-column flex-center rounded-3 bg-gray-100 py-15 px-10">
												...
												<div class="w-100 mb-10">
													...
													<!--begin::Item-->
													<div class="d-flex flex-stack mb-5">
														<span class="fw-semibold fs-6 text-gray-600 text-start pe-3">Keen Analytics Platform</span>
														<i class="ki-duotone ki-check-circle fs-2 text-primary">
															<span class="path1"></span>
															<span class="path2"></span>
														</i>
													...
													<!--begin::Item-->
													<div class="d-flex flex-stack mb-5">
														<span class="fw-semibold fs-6 text-gray-600 text-start pe-3">Targets Timelines & Files</span>
														<i class="ki-duotone ki-check-circle fs-2 text-primary">
															<span class="path1"></span>
															<span class="path2"></span>
														</i>
													...
													<!--begin::Item-->
													<div class="d-flex flex-stack">
														<span class="fw-semibold fs-6 text-gray-600 text-start pe-3">Unlimited Projects</span>
														<i class="ki-duotone ki-check-circle fs-2 text-primary">
															<span class="path1"></span>
															<span class="path2"></span>
														</i>
				...
				<div class="container-xxl position-relative">
					...
					<div class="me-5">
						...
						<div class="mb-11 position-relative z-index-3">
							<!--begin::Title-->
							<h3 class="fs-lg-2tx fs-2x fw-bold text-gray-900 fw-bold mb-7 lh-base">All-In-One Solution To Design,
							<br />Build and Deploy Your App Today
							<br /></h3>
							<!--end::Title-->
							<!--begin::Text-->
							<span class="text-gray-700 d-block fw-semibold fs-4 pb-5 lh-lg">The most well thought out design theme I have ever used. 
							...
							<!--end::Text-->
							<!--begin::Text-->
							<span class="text-gray-700 fw-semibold fs-4 lh-lg">In fact the cleanest and the most up to standard codes are up to 
					...
					<div class="card border-0 bg-gray-100">
						...
						<div class="card-body p-lg-20">
							...
							<div class="text-center pt-lg-5 mb-7">
								<!--begin::Title-->
								<h3 class="fs-2tx text-gray-900 mb-5" id="projects" data-kt-scroll-offset="{default: 100, lg: 150}">Good Projects</h3>
								<!--end::Title-->
							</div>
							<!--end::Heading-->
							<!--begin::Tabs wrapper-->
							<div class="d-flex flex-center mb-5 mb-lg-12">
								<!--begin::Tabs-->
								<ul class="nav border-transparent flex-center fs-4 fw-semibold">
									<li class="nav-item">
						...
						<div class="row py-10 py-lg-20">
							...
							<div class="col-lg-6 mb-10 mb-lg-0">
								...
								<div class="rounded landing-border p-9 mb-6">
									...
									<a href="https://keenthemes.com/support" class="fw-semibold fs-4 text-gray-800 text-hover-primary">support@keenthemes.com</a></span>
									<!--end::Text-->
								</div>
								<!--end::Block-->
								<!--begin::Block-->
								<div class="rounded landing-border p-9">
									...
									<a href="pages/user-profile/overview.html" class="fw-semibold fs-4 text-gray-800 text-hover-primary">Click to Get a Quote</a></span>
									<!--end::Text-->
								</div>
								<!--end::Block-->
							</div>
					...
					<div class="container">
						...
						<div class="d-flex flex-column flex-md-row flex-stack py-8">
							...
							<div class="d-flex align-items-center order-2 order-md-1">
								...
								<!--end::Logo image-->
								<!--begin::Logo image-->
								<span class="mx-5 fs-6 fw-semibold text-gray-700 pt-1" href="https://keenthemes.com">Copyright &copy; KeenThemes 2024</span>
								<!--end::Logo image-->
							</div>
							<!--end::Copyright-->
							<!--begin::Menu-->
