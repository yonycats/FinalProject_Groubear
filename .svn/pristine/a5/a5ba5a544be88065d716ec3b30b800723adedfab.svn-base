							...
							<div class="current" data-kt-stepper-element="content">
								<div class="w-100 pt-10">
									<div class="mb-10 fv-row">
										<input type="text" class="form-control form-control-lg form-control-solid" name="deptNm" placeholder="부서명을 입력해주세요" id="deptNmInput"/>
																...
																<div class="col-12 d-flex flex-wrap justify-content-center align-items-center" id="addTeamCard">
																	<div class="col-12" style="padding : 15px;">
																		<div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-6 d-flex">
																			<input type="text" class="form-control form-control-lg form-control-solid text-center" value="" placeholder="팀명 입력" id="teamNameInput">
																			<div class="m-0">
